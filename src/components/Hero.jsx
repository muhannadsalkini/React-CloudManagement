    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className="flex flex-col justify-center md:items-start w-full px-2 py-8">
          <p className="text-2xl">Unique Squence & Production</p>
          <h1 className="py-3 text-5xl md:text-7xl font-bold">
            Cloud Managment
          </h1>
          <p className="text-2xl">This is our Tench Brand</p>
        ...
        mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-300 border-slate-300 rounded-xl text-center shadow-xl"
        >
